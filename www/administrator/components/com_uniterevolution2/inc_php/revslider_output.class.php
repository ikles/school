					...
					switch($type){
						...
						case "image":
							...
							if(!empty($imageLink)){
								...
								$linkID = UniteFunctionsRev::getVal($layer, "attrID","");
								$linkClass = UniteFunctionsRev::getVal($layer, "attrClasses","");
								$linkTitle = UniteFunctionsRev::getVal($layer, "attrTitle","");
								$linkRel = UniteFunctionsRev::getVal($layer, "attrRel","");
